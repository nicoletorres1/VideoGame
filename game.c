...
//Draw the Paddles and Ball, just gonna label everything layers to keep it consistent
...
Layer fieldLayer =
  {
    ...
    {0,0}, {0,0},
    COLOR_PINK, //color of game frame
  };
...
Layer layer1 = //Paddle for player 1
  {
    ...
    {0,0}, {0,0},
    COLOR_YELLOW, //color of player 1
    &layer3 //ball layer
  };
...
Layer layer2 = //Same as player 1, just move it to the other side
  {
    ...
    {0,0}, {0,0},
    COLOR_PURPLE, //color of player 2
    &layer1 //p1 layer
  };
...
u_int bgColor = COLOR_BLACK; //background color of screen
int redrawScreen = 1;
Region fieldFence;
  ...
  if(count == 10)
	...
	case 1: //Case for when the game reaches 3, announces winner winner
	  ...
	  if(player1Score > player2Score)
	    drawString5x7(20, 50, " PLAYER 1 WINS ", COLOR_WHITE, COLOR_BLACK);
	  
	  else if(player1Score < player2Score)
	    drawString5x7(20, 50, " PLAYER 2 WINS ", COLOR_WHITE, COLOR_BLACK);
	  break;
	}
...
void main()
{
  ...
  for(;;)//Dont get this part, would a while loop just work? Copied from shape demo
	...
	{ // Pause CPU if screen doesn't need updating
      ...
      //P1 Score
      drawChar5x7(5, 150, player1Score, COLOR_WHITE, COLOR_BLACK);
      
      //P2 Score
      drawChar5x7(115, 150, player2Score, COLOR_WHITE, COLOR_BLACK);
      
      //Mother of all Pongs
      drawString5x7(5, 5, "*   ---PONG---   *", COLOR_WHITE, COLOR_BLACK);
      
      //Glance at Victory
      drawString5x7(25, 150, "---SCORE---", COLOR_WHITE, COLOR_BLACK);
    }
}
